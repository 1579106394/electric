    ...
    <div class="page-content">
        <div class="content">
            ...
            <form id="staffForm" class="layui-form xbs layui-form-pane"
                  action="${pageContext.request.contextPath}/money/moneyList.action" method="post">
            ...
            <table class="layui-table">
                ...
                <c:forEach items="${page.list}" var="money">
                    <tr>
                        ...
                        <td>${money.user.userPhone}</td>
                        <td>${money.user.userSex==1?"男":"女"}</td>
                        <td>${money.moneyMoney}</td>
                        <td>${money.moneyTime}</td>
                        <td class="td-manage">
                            <a title="删除" href="javascript:;" onclick="deleteMoney('${money.moneyId}')"
...
<script>
    ...
    function deleteMoney(id) {
        layer.confirm('确认要删除吗？', function (index) {
            window.location.href = "${pageContext.request.contextPath}/money/deleteMoney.action?moneyId=" + id
        });
    }
