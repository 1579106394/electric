    ...
    <div class="page-content">
        <div class="content">
            ...
            <form class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/api/staff/editInfo.html"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_staff_account" value="${staff.staffAccount}" name="staffAccount"
                               required=""
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="password" id="L_staff_password" value="${staff.staffPassword}" name="staffPassword"
                               required=""
                ...
                <div class="layui-form-item">
                    <label for="L_staff_img" class="layui-form-label">
                        头像
                    </label>
                    <div class="layui-input-inline">
                        <input type="file" id="L_staff_img" name="photo" required=""
                               autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-input-inline">
                        <img src="${pageContext.request.contextPath}/${staff.staffImg}" style="width: 40px; height: 40px;">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_staff_telephone" value="${staff.staffTelephone}" name="staffTelephone"
                               required=""
                               autocomplete="off" class="layui-input">
                    </div>
