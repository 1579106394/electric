    ...
    <div class="page-content">
        <div class="content">
            ...
            <form id="staffForm" class="layui-form xbs layui-form-pane"
                  action="${pageContext.request.contextPath}/price/priceList.action" method="post">
                <input type="hidden" id="currentPage" name="currentPage" value="${page.currentPage}"/>
                <div class="" style="text-align: center;">
                    <div class="layui-form-item" style="display: inline-block;">
                        <label class="layui-form-label xbs768">月份</label>
                        <div class="layui-input-inline xbs768">
                            <input class="layui-input" name="params[priceMonth]" value="${page.params.priceMonth}"
